...
const color_bg_button_disabled* = "#303030".color
...
const color_bg_accent_button_disabled* = color_bg_button_disabled


const color_fg* = "#cbcbcb".color
const color_fg_active* = "#ffffff".color   ## for hovered and pressed controls
const color_fg_pressed* = "#ababab".color  ## for icon-like buttons
const color_fg_accent* = "#202020".color   ## for controls with background color_bg_accent_XXX
const color_fg_disabled* = "#8b8b8b".color
...
const color_border_button_disabled* = color_border_button

const color_border_accent_button* = color_accent.lighten(0.2)
const color_border_accent_button_disabled* = color_border_button_disabled
...
const color_border_panel* = "#404040".color
...
const padding_panel_horizontal* = padding_default_horizontal * 2
const padding_panel_vertical* = padding_default_vertical * 2
